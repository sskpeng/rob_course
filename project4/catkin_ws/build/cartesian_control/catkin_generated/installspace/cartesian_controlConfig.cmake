...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cartesian_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/skpeng/robot_course/project4/catkin_ws/install/${idir}'.  Ask the maintainer 'matei <matei@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/skpeng/robot_course/project4/catkin_ws/install/lib;/opt/ros/kinetic/lib)
